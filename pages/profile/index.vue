<template>
	<div class="container">
		<div class="mobile" v-if="user">
			...
			<div class="list">
				<div class="header">
					<h3>{{ $t('pages.profile.index.rooms.title') }}</h3>
				...
				<div v-else>
					<p>{{ $t('pages.profile.index.rooms.description') }}</p>
					<p>{{ $t('pages.profile.index.rooms.helper') }}</p>
				</div>
			</div>
			<div class="list">
				<div class="header">
					<h3>{{ $t('pages.profile.index.walls.title') }}</h3>
				...
				<div v-else>
					<p>{{ $t('pages.profile.index.walls.description') }}</p>
					<p>{{ $t('pages.profile.index.walls.helper') }}</p>
				</div>
			</div>
		</div>

		<div class="introduction desktop" v-if="intro">
